...
<p><?php _e( 'You can create a tour and add as many steps to it as you want from "Create a Tour" tab. You can add step title, step description, link the step to a specific dom element and add a custom class to it. You can also choose to display the tour only once or show it everytime you reload a page (test mode) and ask for confirmation when the user clicks the close button. Another cool feature is the ability to choose on which pages to display the tour. You can also change the background color of the step buttons via the "Style" tab.', 'simple-tour-guide' ); ?><p>
...
<p><?php _e( 'The plugin currently supports only one tour, however you can add an additional tour. Check Shepherd.js documentation on how to do it.', 'simple-tour-guide' ); ?><p>
